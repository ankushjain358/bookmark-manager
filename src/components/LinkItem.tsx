...
export function LinkItem({ link }: LinkItemProps) {
  ...
  return (
    <div className={`group relative flex items-center justify-between rounded-xl border border-border bg-card/45 hover:bg-card/75 hover:border-violet-500/20 transition-all duration-300 ${hideHostnames ? 'p-2' : 'p-3.5'}`}>
